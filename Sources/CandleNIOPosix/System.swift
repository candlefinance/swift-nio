...
internal enum Posix: Sendable {
    ...
    #elseif os(Linux) || os(FreeBSD) || os(Android)
    #if os(Android)
    static let IPTOS_ECN_NOTECT: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_NOTECT)
    #else
    static let IPTOS_ECN_NOTECT: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_NOT_ECT)
    #endif
    static let IPTOS_ECN_MASK: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_MASK)
    static let IPTOS_ECN_ECT0: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_ECT0)
    static let IPTOS_ECN_ECT1: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_ECT1)
    static let IPTOS_ECN_CE: CInt = CInt(CandleCNIOLinux.IPTOS_ECN_CE)
    #elseif os(Windows)
    ...
    #if canImport(Darwin)
    static let IP_RECVPKTINFO: CInt = CandleCNIODarwin.IP_RECVPKTINFO
    static let IP_PKTINFO: CInt = CandleCNIODarwin.IP_PKTINFO

    static let IPV6_RECVPKTINFO: CInt = CNIODarwin_IPV6_RECVPKTINFO
    static let IPV6_PKTINFO: CInt = CNIODarwin_IPV6_PKTINFO
    #elseif os(Linux) || os(FreeBSD) || os(Android)
    static let IP_RECVPKTINFO: CInt = CInt(CandleCNIOLinux.IP_PKTINFO)
    static let IP_PKTINFO: CInt = CInt(CandleCNIOLinux.IP_PKTINFO)

    static let IPV6_RECVPKTINFO: CInt = CInt(CandleCNIOLinux.IPV6_RECVPKTINFO)
    static let IPV6_PKTINFO: CInt = CInt(CandleCNIOLinux.IPV6_PKTINFO)
    #elseif os(Windows)
